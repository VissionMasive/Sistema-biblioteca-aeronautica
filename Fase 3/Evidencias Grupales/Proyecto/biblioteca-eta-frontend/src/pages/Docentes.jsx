...
export default function Docentes() {
  ...
  const accesos = [
    ...
    { label: "Catalogo", to: "/catalogo", icon: <FaBook className="h-20 w-20 text-slate-700 mx-auto mt-8" /> },
    { label: "Agregar Nuevo Libro", to: "/agregarLibro", icon: <FaBook className="h-20 w-20 text-slate-700 mx-auto mt-8" /> },
    { label: "Solicitudes", to: "/solicitudes", icon: <FaBookMedical className="h-20 w-20 text-slate-700 mx-auto mt-8" /> },
    { label: "Reporte", to: "/reporte", icon: <HiDocumentReport className="h-20 w-20 text-slate-700 mx-auto mt-8" /> },
