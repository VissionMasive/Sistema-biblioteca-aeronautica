    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout/>}>
          ...
          <Route path='/normativa-estudiantil' element={<NormativaEstudiantil/>}/>
          ...
          <Route path='/biblioteca-y-horarios' element={<div className='p-4 bg-white rounded shadow'>Próximamente: Biblioteca y Horarios</div>} />
